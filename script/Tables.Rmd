---
title: "Tables for the paper 'Refitting the context: A reconsideration of the Aurignacian sequence at Fumane Cave through spatial taphonomy and lithic technology'"
date: ''
knit: (function(input, ...) {
    rmarkdown::render(
      input,
