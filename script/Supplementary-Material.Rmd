...
subtitle: "Refitting the context: A reconsideration of the Aurignacian stratigraphic sequence at Fumane Cave through spatial taphonomy and lithic technology"
knit: (function(input, ...) {
    rmarkdown::render(
      input,
      output_dir = "../output"
